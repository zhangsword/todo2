    ...
    $scope.toggleOnline = function() {
      ...
      if ($scope.online) {  // Read http://pouchdb.com/api.html#sync
    	  var options = {
    	            ...
    	            continuous: true,
    	            auth: {
    	            	username: '0dadb0e5-38ef-42bb-b4cf-e046376797f0-bluemix',
    	                password: 'xxxxxxxxxxxxxxxxx'
    	            }
    	        };
        $scope.sync = $scope.tasks.$db.replicate.sync('https://0dadb0e5-38ef-42bb-b4cf-e046376797f0-bluemix.cloudant.com/' + dbName, options)
